...
void Board::printGame(){
    for(int i = 0; i < 8; i++){
        ...
        for(int j = 0; j < 8; j++){
            int mask = i*8 + j;
            string piece = ".";
            if((whiteQueen >> mask) & 1) piece = "WQ";
            else if((whitePawn >> mask) & 1) piece = "wp";
            else if((whiteBishop >> mask) & 1) piece = "WB";
            else if((whiteKing >> mask) & 1) piece = "WKg";
            else if((whiteRook >> mask) & 1) piece = "WR";
            else if((whiteKnight >> mask) & 1) piece = "Wk";

            else if((blackQueen >> mask) & 1) piece = "BK";
            else if((blackPawn >> mask) & 1) piece = "bp";
            else if((blackBishop >> mask) & 1) piece = "BB";
            else if((blackKing >> mask) & 1) piece = "BKg";
            else if((blackRook >> mask) & 1) piece = "BR";
            else if((blackKnight >> mask) & 1) piece = "Bk";
